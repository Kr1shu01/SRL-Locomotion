...
class x02comCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        ...
        num_actions = 10
        num_envs = 4096
        episode_length_s = 2 * 1.98 # episode length in seconds
    ...
    class rewards:
        ...
        # cycle_time = 0.35  # 调整周期时间，使跳跃更频繁
        cycle_time = 0.5
        cycle_time1 = 1.0
        cycle_time2 = 0.5
        only_positive_rewards = True
        tracking_sigma = 0.5
        max_contact_force = 500  # 增加最大接触力
        class scales:
            joint_pos = 3.0
            orientation = 3.0
...
class x02comCfgPPO(LeggedRobotCfgPPO):
    seed = 5
